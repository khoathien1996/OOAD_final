            ...
            try
            {
                ...
                if (drDataReader1.HasRows)
                {
                    ...
                    if (String.Compare(Encrypt(x.strPass), passEncrypt) == 0) // Login successfull
                    {
                        ...
                        conn.Close();
                        MessageBox.Show("Đăng nhập thành công! Xin chào " + x.strTenDN, "Thông báo", MessageBoxButton.OK, MessageBoxImage.Information);
                ...
                {
                    MessageBox.Show("Tên đăng nhập không tồn tại, xin nhập lại?", "Thông báo", MessageBoxButton.OK, MessageBoxImage.Warning);
                    //if (MessageBox.Show("Tên đăng nhập không tồn tại, xin nhập lại?", "Thông báo", MessageBoxButton.YesNo, MessageBoxImage.Warning) == MessageBoxResult.Yes)
                    //{
